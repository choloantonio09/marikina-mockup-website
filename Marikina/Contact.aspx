<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Marikina.Contact" %>
   ...
   <!-- BEGIN CONTAINER -->
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="image"><img class="undefined" runat="server" src="~/assets/img/contact_banner.png" style="width:1349px; height:450px; padding-bottom:10px;"></div>
                     <!-- BEGIN CONTENT BODY -->
                <!-- BEGIN PAGE HEAD-->
                <div class="page-head">
                    <div class="container">
                            ...
                            <div class="c-content-contact-1 c-opt-1">
                                <div class="row" data-auto-height=".c-height">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="c-body">
                                            <div class="c-section">
                                                <h3>Marikina Philippines</h3>
                                            </div>
                                            <div class="c-section">
                                                <div class="c-content-label uppercase bg-blue">Address</div>
                                                <p>Marikina City Hall, Shoe Avenue
                                                    <br/>Sta. Elena, Marikina City 1800
                                                    <br/>Philippines</p>
                                            </div>
                                            <div class="c-section">
                                                <div class="c-content-label uppercase bg-blue">Contacts</div>
                                                <p>
                                                    <strong>T</strong> (632) 646 - 2360 / 70
                                                    <br/>
                                                    <strong>F</strong> (632) 646 - 5277</p>
                                            </div>
                                            <div class="c-section">
                                    ...
                                    <div class="col-md-6">
                                        <div class="c-container bg-green">
                                            <div class="c-content-title-1 c-inverse">
                                                ...
                                                <p class="c-font-lowercase">Try visiting our FAQ page to learn more about our greatest city, Marikina.</p>
